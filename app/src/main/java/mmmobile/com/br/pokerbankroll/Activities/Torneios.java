...
import mmmobile.com.br.pokerbankroll.Adapters.adpTorneios;
...
public class Torneios extends AppCompatActivity {

    @SuppressLint("StaticFieldLeak")
    public static adpTorneios mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView mRecyclerView = (RecyclerView) findViewById(R.id.rvTorneios);
        if (mRecyclerView != null) {
            mRecyclerView.setLayoutManager(new LinearLayoutManager(Torneios.this));
            mRecyclerView.addItemDecoration(new SpacesItemDecoration());
        }

        mAdapter = new adpTorneios(
                Torneios.this,
                mRecyclerView,
        ...
        if (btnAdd != null) {
            btnAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(Torneios.this, ManutencaoTorneios.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.mnu_torneios, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.mnuAlterar) {
            ...
            if (mAdapter.mItemSelected == -1) {
                Funcoes.showMessage(Torneios.this, getString(R.string.a_003), getString(R.string.e_005), getString(R.string.o_001));
            } else {
                Intent intent = new Intent(Torneios.this, ManutencaoTorneios.class);
        ...
        if (id == R.id.mnuExcluir) {
            ...
            if (mAdapter.mItemSelected == -1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Torneios.this);

                builder.setTitle(getString(R.string.c_004));

                String sMessage = getString(R.string.d_007);
                sMessage = sMessage.replace("@1", mAdapter.mListTorneios.get(mAdapter.mItemSelected).getDtTorneio());
    ...
    private void montaComboOrdem() {
        ...
        String[] vOrdem = {
                ...
                getString(R.string.m_010),
                getString(R.string.p_003)
        };
